...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/mayur/autonomous/src/perception)
  set(perception_DEVEL_PREFIX /home/mayur/autonomous/devel/.private/perception)
  ...
  set(perception_INSTALL_PREFIX /home/mayur/autonomous/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'mayur <mayur@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mayur/autonomous/src/perception/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mayur/autonomous/devel/.private/perception/lib;/home/mayur/autonomous/devel/lib;/opt/ros/noetic/lib)
